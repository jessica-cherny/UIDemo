...
//  UIProgrammingDemo
//
//  Created by Jessica  Cherny on 3/18/16.
...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        placeImageView.image = UIImage(named: "amalfi")
        ...
        placeNameLabel.text = "Amalfi Coast"
        ...
        thingsLabel.text = "Ravello, Amalfitana, Positano, Furore Beach, Capri, Gelatarias, Restaurants, Churches, Blue Grotto, Boat Trips, Shopping, etc."
        ...
        pinButton.backgroundColor = UIColor(red: 1, green: 0.502, blue: 1, alpha: 1)
        ...
        goButton.backgroundColor = UIColor(red: 1, green: 0.502, blue: 1, alpha: 1)
        ...
        inviteFriendsButton.backgroundColor = UIColor(red: 1, green: 0.502, blue: 1, alpha: 1)
